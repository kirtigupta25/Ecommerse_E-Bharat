...
import { deleteFromCart, clearCart } from '../../redux/cartSlice'; // Import clearCart action
...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_x5Ua6wMONdXKor",
      key_secret: "vKSyuQvGDRwerwdWcoUor0il",
  ...
  return (
    <Layout>
      <div className="h-full bg-gray-100 pt-5 pb-20" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '' }}>
